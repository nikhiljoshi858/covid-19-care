...
# Filename:           models.py
# Functions:          No functions. This file lays down the models used for new user creation and recording the previous results.
#                     The previous results data is generated after using the system modules.
# Global Variables:   NA
