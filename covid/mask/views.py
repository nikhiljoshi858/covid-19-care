...
#                   Like the image_view or webcam_view, the video is not displayed directly, but it can be downloaded 
#                   and played by the user locally
# Example Call:		Called by Django when the particular URL is called by the user
